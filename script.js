...
const teamMembers = {
    1: {
        ...
        bio: `<p>Justin is a Computer Science student at Washington University in St. Louis. At WashU, he serves as a Teaching Assistant for Introduction to Computer Science and Introduction to Computer Engineering, where he teaches over 200 students through lectures and office hours. In the same courses, he also serves as a proctor and grader for exams and assignments, supporting large course sections with more than 800 total students. In addition, he tutors college-level calculus and matrix algebra, with 81% of his students improving their grades from a B range to an A.</p>
